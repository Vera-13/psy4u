...
user6 = User.new(first_name: "Leone", last_name: "Claser", email: "leone.claser@gmail.com", address: "Boulevard du Triomphe 172, Bruxelles,  1210, Belgium", password: "123456", is_doctor: true, price_session: "75", phone_nr: "+32 706 065 266", about: "Welcome to my corner of insight and understanding. As a dedicated psychologist, I'm committed to guiding individuals through their unique journeys of self-discovery and healing. With a blend of empathy, expertise, and a passion for mental wellness, I strive to create a safe, nurturing space where my clients can explore, grow, and thrive. Join me as we navigate the complexities of the human mind and embark on a transformative path toward well-being and fulfillment")
...
user8 = User.new(first_name: "Lucas", last_name: "Rave", email: "lucas.rave@gmail.com", address: "	Avenue d'Auderghem 259, Ixelles, 1050, Belgium", password: "123456", is_doctor: true, price_session: "75", phone_nr: "+32 745 435 246", about: "Welcome to my corner of insight and understanding. As a dedicated psychologist, I'm committed to guiding individuals through their unique journeys of self-discovery and healing. With a blend of empathy, expertise, and a passion for mental wellness, I strive to create a safe, nurturing space where my clients can explore, grow, and thrive. Join me as we navigate the complexities of the human mind and embark on a transformative path toward well-being and fulfillment")
...
user11 = User.new(first_name: "Christine", last_name: "Smith", email: "christine.smith@gmail.com", address: "Boulevard Poincare 80, Uccle, 1180, Belgium", password: "123456", is_doctor: true, price_session: "75", phone_nr: "+32 455 065 276", about: "Welcome to my corner of insight and understanding. As a dedicated psychologist, I'm committed to guiding individuals through their unique journeys of self-discovery and healing. With a blend of empathy, expertise, and a passion for mental wellness, I strive to create a safe, nurturing space where my clients can explore, grow, and thrive. Join me as we navigate the complexities of the human mind and embark on a transformative path toward well-being and fulfillment")
...
user12 = User.new(first_name: "Arthur", last_name: "Dutoit", email: "arthur.dutoit@gmail.com", address: "Koning Albert II laan 27, Uccle, 1180, Belgium", password: "123456", is_doctor: true, price_session: "75", phone_nr: "+32 985 035 200", about: "Welcome to my corner of insight and understanding. As a dedicated psychologist, I'm committed to guiding individuals through their unique journeys of self-discovery and healing. With a blend of empathy, expertise, and a passion for mental wellness, I strive to create a safe, nurturing space where my clients can explore, grow, and thrive. Join me as we navigate the complexities of the human mind and embark on a transformative path toward well-being and fulfillment")
...
user13 = User.new(first_name: "Erika", last_name: "Ramirez", email: "erica.ramirez@gmail.com", address: "Auguste Reyerslaan 52, Uccle, 1180, Belgium", password: "123456", is_doctor: true, price_session: "75", phone_nr: "+32 985 035 200", about: "Welcome to my corner of insight and understanding. As a dedicated psychologist, I'm committed to guiding individuals through their unique journeys of self-discovery and healing. With a blend of empathy, expertise, and a passion for mental wellness, I strive to create a safe, nurturing space where my clients can explore, grow, and thrive. Join me as we navigate the complexities of the human mind and embark on a transformative path toward well-being and fulfillment")
...
user18 = User.new(first_name: "Saira", last_name: "Roth", email: "saira.roth@gmail.com", address: "Avenue du Grand Forestier 2, Jette, 1090, Belgium", password: "123456", is_doctor: true, price_session: "75", phone_nr: "+32 985 035 200", about: "Welcome to my corner of insight and understanding. As a dedicated psychologist, I'm committed to guiding individuals through their unique journeys of self-discovery and healing. With a blend of empathy, expertise, and a passion for mental wellness, I strive to create a safe, nurturing space where my clients can explore, grow, and thrive. Join me as we navigate the complexities of the human mind and embark on a transformative path toward well-being and fulfillment")
...
user19 = User.new(first_name: "Chloe", last_name: "Farley", email: "chloe.farley@gmail.com", address: "	Birminghamstraat 112, Jette, 1090, Belgium", password: "123456", is_doctor: true, price_session: "75", phone_nr: "+32 985 035 200", about: "Welcome to my corner of insight and understanding. As a dedicated psychologist, I'm committed to guiding individuals through their unique journeys of self-discovery and healing. With a blend of empathy, expertise, and a passion for mental wellness, I strive to create a safe, nurturing space where my clients can explore, grow, and thrive. Join me as we navigate the complexities of the human mind and embark on a transformative path toward well-being and fulfillment")
...
user20 = User.new(first_name: "Automn", last_name: "Melton", email: "automn.melton@gmail.com", address: "Chaussee de Wavre 68, Jette, 1090, Belgium", password: "123456", is_doctor: true, price_session: "75", phone_nr: "+32 985 035 200", about: "Welcome to my corner of insight and understanding. As a dedicated psychologist, I'm committed to guiding individuals through their unique journeys of self-discovery and healing. With a blend of empathy, expertise, and a passion for mental wellness, I strive to create a safe, nurturing space where my clients can explore, grow, and thrive. Join me as we navigate the complexities of the human mind and embark on a transformative path toward well-being and fulfillment")
...
Review.create!(patient_id: pat9.id, doctor_id: user4.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "3.0")
...
Review.create!(patient_id: pat6.id, doctor_id: user4.id, comment: "A skilled professional with a remarkable ability to provide clarity amidst chaos, this psychologist's guidance instilled confidence and a renewed sense of purpose.", rating: "3.0")
...
Review.create!(patient_id: pat7.id, doctor_id: user5.id, comment: "Incredible psychologist - their nuanced approach and genuine empathy helped me navigate challenges, fostering a sense of self-awareness and inner strength.", rating: "5.0")
Review.create!(patient_id: pat6.id, doctor_id: user5.id, comment: "A skilled professional with a remarkable ability to provide clarity amidst chaos, this psychologist's guidance instilled confidence and a renewed sense of purpose.", rating: "5.0")
...
Review.create!(patient_id: pat9.id, doctor_id: user6.id, comment: "A compassionate and knowledgeable psychologist whose expertise and patience created a space for deep reflection, guiding me toward sustainable mental wellness.", rating: "4.0")
...
Review.create!(patient_id: pat7.id, doctor_id: user6.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
...
Review.create!(patient_id: pat5.id, doctor_id: user6.id, comment: "A skilled professional with a remarkable ability to provide clarity amidst chaos, this psychologist's guidance instilled confidence and a renewed sense of purpose.", rating: "4.0")
...
Review.create!(patient_id: pat1.id, doctor_id: user8.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "5.0")
...
Review.create!(patient_id: pat8.id, doctor_id: user8.id, comment: "A compassionate and knowledgeable psychologist whose expertise and patience created a space for deep reflection, guiding me toward sustainable mental wellness.", rating: "5.0")
Review.create!(patient_id: pat9.id, doctor_id: user8.id, comment: "A skilled professional with a remarkable ability to provide clarity amidst chaos, this psychologist's guidance instilled confidence and a renewed sense of purpose.", rating: "5.0")
...
Review.create!(patient_id: pat2.id, doctor_id: user9.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
...
Review.create!(patient_id: pat10.id, doctor_id: user9.id, comment: "A compassionate and knowledgeable psychologist whose expertise and patience created a space for deep reflection, guiding me toward sustainable mental wellness.", rating: "4.0")
...
Review.create!(patient_id: pat5.id, doctor_id: user10.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
...
Review.create!(patient_id: pat7.id, doctor_id: user10.id, comment: "A compassionate and knowledgeable psychologist whose expertise and patience created a space for deep reflection, guiding me toward sustainable mental wellness.", rating: "4.0")
...
Review.create!(patient_id: pat3.id, doctor_id: user11.id, comment: "A skilled professional with a remarkable ability to provide clarity amidst chaos, this psychologist's guidance instilled confidence and a renewed sense of purpose.", rating: "4.0")
...
Review.create!(patient_id: pat2.id, doctor_id: user11.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
...
Review.create!(patient_id: pat3.id, doctor_id: user12.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
Review.create!(patient_id: pat4.id, doctor_id: user12.id, comment: "Thank you for the support and your help.", rating: "4.0")
Review.create!(patient_id: pat5.id, doctor_id: user12.id, comment: "A compassionate and knowledgeable psychologist whose expertise and patience created a space for deep reflection, guiding me toward sustainable mental wellness.", rating: "4.0")
Review.create!(patient_id: pat6.id, doctor_id: user12.id, comment: "Incredible psychologist - their nuanced approach and genuine empathy helped me navigate challenges, fostering a sense of self-awareness and inner strength.", rating: "4.0")
...
Review.create!(patient_id: pat6.id, doctor_id: user13.id, comment: "A compassionate and knowledgeable psychologist whose expertise and patience created a space for deep reflection, guiding me toward sustainable mental wellness.", rating: "4.0")
...
Review.create!(patient_id: pat9.id, doctor_id: user13.id, comment: "Highly skilled and empathetic, this psychologist provided invaluable support, guiding me towards greater mental clarity.", rating: "4.0")
...
Review.create!(patient_id: pat3.id, doctor_id: user14.id, comment: "Incredibly skilled and compassionate, this psychologist's ability to listen attentively and provide tailored guidance fostered immense progress in my mental health journey.", rating: "4.0")
...
Review.create!(patient_id: pat5.id, doctor_id: user14.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
Review.create!(patient_id: pat6.id, doctor_id: user14.id, comment: "Incredible psychologist - their nuanced approach and genuine empathy helped me navigate challenges, fostering a sense of self-awareness and inner strength.", rating: "4.0")
Review.create!(patient_id: pat7.id, doctor_id: user14.id, comment: "A compassionate and knowledgeable psychologist whose expertise and patience created a space for deep reflection, guiding me toward sustainable mental wellness.", rating: "4.0")
...
Review.create!(patient_id: pat10.id, doctor_id: user15.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
...
Review.create!(patient_id: pat6.id, doctor_id: user15.id, comment: "An outstanding psychologist whose empathy and expertise truly made a positive difference in my life.", rating: "4.0")
Review.create!(patient_id: pat5.id, doctor_id: user15.id, comment: "Exceptional psychologist!.", rating: "4.0")
Review.create!(patient_id: pat4.id, doctor_id: user15.id, comment: "Highly skilled and empathetic, this psychologist provided invaluable support, guiding me towards greater mental clarity.", rating: "4.0")
...
Review.create!(patient_id: pat4.id, doctor_id: user16.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
...
Review.create!(patient_id: pat6.id, doctor_id: user16.id, comment: "A skilled professional with a remarkable ability to provide clarity amidst chaos, this psychologist's guidance instilled confidence and a renewed sense of purpose.", rating: "4.0")
...
Review.create!(patient_id: pat8.id, doctor_id: user16.id, comment: "A true beacon of support, this psychologist's insightful advice and empathetic nature helped me navigate complexities, enabling profound personal growth.", rating: "4.0")
...
Review.create!(patient_id: pat6.id, doctor_id: user17.id, comment: "Incredible psychologist - their nuanced approach and genuine empathy helped me navigate challenges, fostering a sense of self-awareness and inner strength.", rating: "4.0")
...
Review.create!(patient_id: pat9.id, doctor_id: user17.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
...
Review.create!(patient_id: pat7.id, doctor_id: user18.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
Review.create!(patient_id: pat6.id, doctor_id: user18.id, comment: "Incredible psychologist - their nuanced approach and genuine empathy helped me navigate challenges, fostering a sense of self-awareness and inner strength.", rating: "4.0")
...
Review.create!(patient_id: pat3.id, doctor_id: user18.id, comment: "A compassionate and knowledgeable psychologist whose expertise and patience created a space for deep reflection, guiding me toward sustainable mental wellness.", rating: "4.0")
Review.create!(patient_id: pat2.id, doctor_id: user18.id, comment: "A true beacon of support, this psychologist's insightful advice and empathetic nature helped me navigate complexities, enabling profound personal growth.", rating: "4.0")
...
Review.create!(patient_id: pat10.id, doctor_id: user19.id, comment: "A compassionate and knowledgeable psychologist whose expertise and patience created a space for deep reflection, guiding me toward sustainable mental wellness.", rating: "4.0")
...
Review.create!(patient_id: pat8.id, doctor_id: user19.id, comment: "Incredible psychologist - their nuanced approach and genuine empathy helped me navigate challenges, fostering a sense of self-awareness and inner strength.", rating: "4.0")
...
Review.create!(patient_id: pat4.id, doctor_id: user20.id, comment: "A compassionate and knowledgeable psychologist whose expertise and patience created a space for deep reflection, guiding me toward sustainable mental wellness.", rating: "4.0")
...
Review.create!(patient_id: pat2.id, doctor_id: user20.id, comment: "Empathetic and insightful, this psychologist's guidance was a pivotal force in my healing journey, offering a fresh perspective and effective coping mechanisms.", rating: "4.0")
Review.create!(patient_id: pat1.id, doctor_id: user20.id, comment: "Incredible psychologist - their nuanced approach and genuine empathy helped me navigate challenges, fostering a sense of self-awareness and inner strength.", rating: "4.0")
...
Review.create!(patient_id: pat7.id, doctor_id: user20.id, comment: "Highly skilled and empathetic, this psychologist provided invaluable support, guiding me towards greater mental clarity.", rating: "4.0")
Review.create!(patient_id: pat9.id, doctor_id: user20.id, comment: "I highly recommend their services for anyone seeking genuine support to mental well-being", rating: "4.0")
...
Review.create!(patient_id: pat8.id, doctor_id: user20.id, comment: "An outstanding psychologist whose empathy and expertise truly made a positive difference in my life.", rating: "4.0")
