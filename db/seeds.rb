...
Review.create!(patient_id: pat6.id, doctor_id: user4.id, comment: "Thank you for the support and your help.", rating: "3.0")
...
Review.create!(patient_id: pat6.id, doctor_id: user5.id, comment: "Outstanding psychologist—professional, empathetic, and transformative.", rating: "5.0")
...
Review.create!(patient_id: pat5.id, doctor_id: user6.id, comment: "Outstanding psychologist—professional, empathetic, and transformative.", rating: "4.0")
Review.create!(patient_id: pat4.id, doctor_id: user6.id, comment: "Outstanding psychologist—professional, empathetic, and transformative.", rating: "4.0")
...
Review.create!(patient_id: pat9.id, doctor_id: user8.id, comment: "Exceptional psychologist - compassionate, insightful, and immensely supportive throughout my journey towards healing.", rating: "5.0")
...
Review.create!(patient_id: pat3.id, doctor_id: user11.id, comment: "Exceptional psychologist!.", rating: "4.0")
...
Review.create!(patient_id: pat3.id, doctor_id: user14.id, comment: "An outstanding psychologist whose empathy and expertise truly made a positive difference in my life.", rating: "4.0")
...
Review.create!(patient_id: pat6.id, doctor_id: user16.id, comment: "Exceptional psychologist!.", rating: "4.0")
Review.create!(patient_id: pat7.id, doctor_id: user16.id, comment: "Exceptional psychologist!.", rating: "4.0")
Review.create!(patient_id: pat8.id, doctor_id: user16.id, comment: "Exceptional psychologist!.", rating: "4.0")
...
Review.create!(patient_id: pat5.id, doctor_id: user18.id, comment: "Thank you for the support and your help.", rating: "4.0")
...
Review.create!(patient_id: pat2.id, doctor_id: user18.id, comment: "Thank you for the support and your help.", rating: "4.0")
...
Review.create!(patient_id: pat3.id, doctor_id: user20.id, comment: "Exceptional psychologist!.", rating: "4.0")
